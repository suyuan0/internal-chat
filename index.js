...
server.listen(HTTP_PORT, "0.0.0.0", () => {
  console.log(`
    ...
    ${chalk.cyan("Local:   http://localhost:" + HTTP_PORT + "/")}
    ${chalk.cyan("Local:   http://127.0.0.1:" + HTTP_PORT + "/")}
    ${chalk.yellow("Network: http://" + localIP + ":" + HTTP_PORT + "/")}
  `);
  // console.log(chalk.cyan(`  Local:   http://localhost:${HTTP_PORT}/`));
  // console.log(chalk.cyan(`  Local:   http://127.0.0.1:${HTTP_PORT}/`));
  // console.log(chalk.yellow(`  Network: http://${localIP}:${HTTP_PORT}/`));
});
